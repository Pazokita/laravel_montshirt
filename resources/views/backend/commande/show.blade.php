...
{{--on use le modèle pivot pour récuperer la taille--}}
                            - Taille: {{$produit->pivot->taille->nom}}</strong> <br>
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-right">{{number_format($commande->tva,2)}} € TTC</td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                    <td>TOTAL</td>
                    <td class="text-right">{{number_format($commande->total_ttc,2)}} € TTC </td>
                </tr>
                </tfoot>
            </table>
        </div>
