                    ...
                    <form action="{{route('commande_store_adresse')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="code_postal" name="code_postal"
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <select class="custom-select d-block w-100" id="pays" required name="pays">
                                    @foreach($pays as $code => $p)
                                        ...
                                        <option
                                            @if(old('pays') == $code || (isset($adresse->pays) && $adresse->pays == $code)) selected
                                            @endif value="{{$code}}">{{$p}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <hr class="mb-4">
                        <button class="btn btn-outline-dark btn-lg btn-block" type="submit" >Procéder au paiement
                        </button>
                    </form>
                </div>
            </div>
