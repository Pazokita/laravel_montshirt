...
@section('content')
    <main role="main">
        ...
        <section class="py-5 text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Commandez votre <br><span class="badge badge-light">nouveau</span> <br>T-Shirt
                    <span class="badge badge-primary ">préféré </span>!</h1>
                    ...
                    @foreach($produits as $produit)
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                ...
                                <img src="{{asset('storage/upload/'.$produit->photo_principale)}}" class="card-img-top
                                img-fluid"
                                     alt="Responsive
                                image">
                                </a>
